...
export class DetailsDialog implements Component {
  ...
  constructor(
    ...
    this.thinkingItem = { value: 'thinking', label: 'Thinking', description: this.thinkingLabel() }
  ...
  private thinkingLabel(): string {
    if (!this.thinkingEnabled) return 'disabled'
    return this.showThinking ? 'shown' : 'hidden'
  }
